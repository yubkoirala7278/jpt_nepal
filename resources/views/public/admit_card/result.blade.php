        ...
        <div class="carousel-inner slider-body">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column h-100 align-items-start justify-content-center ">
                    <h1 class="display-5 fw-bold text-start" data-aos="fade-right" data-aos-duration="1500">Check Result</h1>
...
<section class="container">
    <div class="row">
        ...
        <div class="col-md-6" data-aos="fade-left" data-aos-duration="1500">
            <img src="{{asset('frontend/img/exam-results.png')}}" class="w-100 image-fluid" style="max-height:350px;object-fit: contain;"
                alt="Result Image" loading="lazy">
        </div>
    </div>

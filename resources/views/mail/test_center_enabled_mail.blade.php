...
<head>
    ...
    <title>Test Center Account Enabled</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>Test Center Account Enabled</h1>
        </div>

        <!-- Content -->
        <div class="content">
            <h2>Good News: Your Test Center Account has been Re-enabled</h2>
            <p>Dear {{ $mailData['name'] }},</p>

            <p>We are pleased to inform you that your test center account has been re-enabled. The details are as follows:</p>

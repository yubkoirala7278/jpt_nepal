...
<head>
    ...
    <title>Test Center Account Disabled</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>Test Center Account Disabled</h1>
        </div>

        <!-- Content -->
        <div class="content">
            <h2>Important Notice: Your Test Center Account has been Disabled</h2>
            <p>Dear {{ $mailData['name'] }},</p>

            <p>We regret to inform you that your test center account has been disabled due to a breach of our company policies. The details are as follows:</p>

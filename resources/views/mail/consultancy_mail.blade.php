...
<head>
    ...
    <title>Consultancy Account Created</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>New Consultancy Account Created</h1>
        </div>

        <!-- Content -->
        <div class="content">
            <h2>Welcome to Japanese Proficiency Test!</h2>
            <p>We are excited to inform you that a new consultancy account has been successfully created with the following details:</p>

            <div class="details">
                <p><strong>Consultancy Name:</strong> {{ $mailData['name'] }}</p>
            ...
            <p>Thank you for choosing <strong>Japanese Proficiency Test</strong> for your consultancy needs!</p>
        </div>

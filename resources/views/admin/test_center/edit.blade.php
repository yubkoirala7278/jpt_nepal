...
@section('content')
    <h2 class="mb-3">Edit Test Center</h2>
    <form action="{{ route('test_center.update',$testCenter->slug) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Enter Test Center Name"
                value="{{ old('name',$testCenter->user->name) }}">
            @if ($errors->has('name'))
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="venue_address" name="venue_address"
                placeholder="Enter Test Center Address" value="{{ old('venue_address',$testCenter->venue_address) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="test_venue" name="test_venue" placeholder="Enter City"
                value="{{ old('test_venue',$testCenter->test_venue) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="venue_code" name="venue_code" placeholder="Enter Venue Code"
                value="{{ old('venue_code',$testCenter->venue_code) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="venue_name" name="venue_name" placeholder="Enter Venue Name"
                value="{{ old('venue_name',$testCenter->venue_name) }}">
        ...
        <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Phone Number"
                value="{{ old('phone',$testCenter->phone) }}">
            @if ($errors->has('phone'))
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="example@user.com"
                value="{{ old('email',$testCenter->user->email) }}">
            @if ($errors->has('email'))
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="John Doe"
                value="{{ old('contact_person',$testCenter->contact_person) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="xxxxxxxxx"
                value="{{ old('mobile_no',$testCenter->mobile_no) }}">

    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
            <i class="fa-solid fa-building-columns"></i><span>Test Centers</span><i class="fas fa-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav-second" data-bs-toggle="collapse" href="#">
            <i class="fa-solid fa-user-graduate"></i><span>Education Consultancy</span><i class="fas fa-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav-third" data-bs-toggle="collapse" href="#">
            <i class="fa-solid fa-laptop-file"></i><span>JPT Applicants</span><i class="fas fa-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav-fourth" data-bs-toggle="collapse" href="#">
            <i class="fa-solid fa-newspaper"></i><span>News & Notice</span><i class="fas fa-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav-sixth" data-bs-toggle="collapse" href="#">
            <i class="fa-solid fa-ticket"></i><span>Admit Card</span><i class="fas fa-chevron-down ms-auto"></i>
        </a>

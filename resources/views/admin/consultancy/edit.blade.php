...
@section('content')
    ...
    <form action="{{route('consultancy.update',$consultancy->slug)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Consultancy name.." value="{{old('name',$consultancy->user->name)}}">
            @if ($errors->has('name'))
        ...
        <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="phone" name="phone" placeholder="Phone number.." value="{{old('phone',$consultancy->phone)}}" >
            @if ($errors->has('phone'))
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="address" name="address" placeholder="Address.." value="{{old('address',$consultancy->address)}}" >
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Email Address.." value="{{old('email',$consultancy->user->email)}}">
            @if ($errors->has('email'))

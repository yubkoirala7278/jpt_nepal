...
{
    use HasFactory;
    protected $fillable = ['slug', 'account_name','account_number','branch_name','qr_code','bank_name'];
    // Boot method to handle model events
    protected static function boot()
    {
        parent::boot();

        // Automatically generate a unique slug when creating a account
        static::creating(function ($account) {
            $account->slug = static::generateUniqueSlug();
        });
    }

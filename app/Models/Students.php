...
{
    use HasFactory;
    protected $fillable = ['name', 'address','amount', 'profile', 'phone', 'slug', 'dob', 'email', 'is_appeared_previously', 'receipt_image', 'user_id','exam_date_id','status','is_viewed_by_admin','is_viewed_by_test_center_manager','citizenship','gender','nationality'];
